...
#		Option( 'usecache', 'Boolean', desc='use cached stage 1 data', default='false' ),
  ...
  #The following option group is for internal testing purposes - not to be used for actual protocols
	...
	Option_Group( 'md',
		...
		Option( 'fep_min', 'Boolean', desc="Booleon to adjust fep based scoreterm behaviour; makes both ligand A and ligand B protein residue-pair-energy calculations as if both ligands were fully on energetically (unscaled). Intended to be used during protein-ligA-ligB minimization and not any MD work. Also only runs in code that runs when -fep_on is True. Default is false.", default="false"),
